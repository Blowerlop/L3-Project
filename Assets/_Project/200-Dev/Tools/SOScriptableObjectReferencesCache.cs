...
//
namespace _Project._200_Dev.Tools
{
    ...
    public class SOScriptableObjectReferencesCache : ScriptableObject
    {
        ...
        public static void FetchReferences()
        {
            ...
            {
                ScriptableObject[] scriptableObjects = Utilities.Utilities.FindAssetsByType<ScriptableObject>(type).Where(t => t.GetType() == type).ToArray();
