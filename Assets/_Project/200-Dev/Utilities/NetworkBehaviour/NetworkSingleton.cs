...
namespace _Project._200_Dev.Utilities.NetworkBehaviour
{
    [DefaultExecutionOrder(-1)]
    public abstract class NetworkSingleton<T> : Unity.Netcode.NetworkBehaviour where T : Unity.Netcode.NetworkBehaviour
    {
